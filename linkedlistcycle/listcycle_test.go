...
var tests = []struct {
	...
	{
		&ListNode{3, &ListNode{2, &ListNode{0, &ListNode{-4, nil}}}},
		&ListNode{2, &ListNode{0, &ListNode{-4, nil}}},
	},
	{
...
func BenchmarkLinkedListCycle(b *testing.B) {
	...
	funcs := []struct {
		...
		{"mine", detectCycle},
		{"mine-fp", detectCycle_fastptr},
		{"leet-0ms", detectCycle_leet0ms},
	}
