...
var tests = []struct {
	...
	{
		list1,
		&ListNode{5, &ListNode{4, &ListNode{1, nil}}},
	},
	{
		list2,
		&ListNode{4, &ListNode{3, &ListNode{1, nil}}},
	},
	{
		list3,
		&ListNode{5, &ListNode{4, &ListNode{4, &ListNode{3, &ListNode{1, &ListNode{1, nil}}}}}},
	},
	{
	...
	},
	{
		...
		&ListNode{4, &ListNode{2, &ListNode{1, nil}}},
	},
	{
	...
	},
	{
		...
		&ListNode{7, &ListNode{6, &ListNode{5, &ListNode{4, &ListNode{3, &ListNode{1, nil}}}}}},
	},
	{
		nil,
		nil,
	...
	},
	{
		...
		&ListNode{143, &ListNode{1, &ListNode{3, &ListNode{4, &ListNode{4, &ListNode{5, &ListNode{5, &ListNode{4, &ListNode{3, &ListNode{2, &ListNode{1, &ListNode{7, &ListNode{6, &ListNode{5, &ListNode{4, &ListNode{3, &ListNode{1, nil}}}}}}}}}}}}}}}}},
	},
}
...
func BenchmarkMerge2Lists(b *testing.B) {
	...
	funcs := []struct {
		...
		{"mine", reverseList},
		{"leet-0ms", reverseList_leet0ms},
		{"leet-1ms", reverseList_leet1ms},
	}
